r = int(input("Введіть значення Red (0–255): "))
g = int(input("Введіть значення Green (0–255): "))
b = int(input("Введіть значення Blue (0–255): "))

if 0 <= r <= 255 and 0 <= g <= 255 and 0 <= b <= 255:
    color = (r, g, b)
    print(f"Кортеж кольору: {color}")
else:
    print("Помилка: усі значення мають бути в діапазоні від 0 до 255.")


# Обробка кожного кольору окремо та виведення інформації (складніший варіант виконання)
while True:
    try:
